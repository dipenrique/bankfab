...
## Environments
- Preview: https://main--bankfab--dipenrique.aem.page/
- Live: https://main--bankfab--dipenrique.aem.live/
...
1. Open the `bankfab` directory in your favorite IDE and start coding :)
